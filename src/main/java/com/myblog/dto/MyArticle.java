...
public class MyArticle {
	...
	public MyArticle(Integer article_id, String article_title, String article_time, Integer sort_article_id,
			String sort_article_name, Integer bloger_id, String bloger_name, Integer reading_count,
			Integer upvote_count,Integer comment_count) {
		super();
	...
	public String toString() {
		return "MyArticle [article_id=" + article_id + ", article_title=" + article_title + ", article_time="
